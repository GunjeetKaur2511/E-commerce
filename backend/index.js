...
const corsOptions = {
  origin: ['https://e-commerce-admin-theta-seven.vercel.app', 'http://localhost:5173'], // Replace with your actual Vercel domain
  methods: ['GET', 'POST'],
  credentials: true
};
...
app.post("/upload",upload.single('product'),(req,res)=>{
    res.json({
        success:1,
        image_url:`https://e-commerce-backend-m42q.onrender.com/images/${req.file.filename}`
    })
})
